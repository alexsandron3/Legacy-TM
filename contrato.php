...
<body class="body">
  <div class="container">
    ...
    <img src="img/logo.jpg" class="float-right logo">
    <h2 class="text-center">CONTRATO DE PRESTAÇÃO DE SERVIÇOS</h2>
    <p class="h4"> <b> <span class="h3"> CONTRATADA:</span> MRtur</b>, com sede em <b> Rua: Horácio, Lt 02 Qd 12 - Jardim Guanabara- Queimados - RJ - CEP 26321-000</b>, inscrita no C.N.P.J. sob o nº
      <b>41.826.987/0001-85</b>, razão social <b>CARLA PATRICIA DE PÁDUA PAULA</b> representada na forma deste
      contrato.
    </p>
    ...
    <p class="text-center text-muted"> Rua: Horácio, Lt 02 Qd 12 - Jardim Guanabara- Queimados - RJ - 21 96544-4090  </p>–
    <hr>
    <img src="img/logo.jpg" class="float-right logo">
    </br>
    ...
    <h3> <b> 13 - FORO </b></h3>
    <p class="h4">Fica estabelecido pelas partes que o foro escolhido é o da comarca de Queimados/RJ, podendo
    ...
    <p class="h4">Jardim Guanabara, <a href="#" id="dob" data-type="date" data-pk="1" data-title="SELECIONE A DATA">dd/mm/aaaa</a>. </p>
    <div class="row">
      <div class="col">
        <img src="img/IMG_5471.jpg" alt="" class="img-assinatura">
        <hr class="bg-dark Assinatura-Linha" style="width: 42.5%;">
        <p class="h4"></p> <b> <span class="Assinatura-Tais-Empresa-Nome">MRtour</span></b></p>
      </div>
      <div class="col mt-3">
